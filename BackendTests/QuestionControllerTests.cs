...
namespace BackendTests
{
    public class QuestionControllerTests
    {
        ...
        public async void GetQuestions_WhenNoParameters_ReturnsAllQuestions()
        {
            ...
            /**
             * We create a mock object from the IDataRepository interface using
             * the Mock class from Moq. Now, we can use the Setup and Returns
             * methods on the mock object to define that the GetQuestions method
             * should return our mock questions. The method we are testing is
             * asynchronous, so we need to wrap the mock questions with Task.FromResult
             * in the mock result.
             * 
             */
